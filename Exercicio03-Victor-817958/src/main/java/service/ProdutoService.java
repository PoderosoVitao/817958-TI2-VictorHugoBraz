...
public class ProdutoService {
	...
	public void makeForm(int tipo, Produto produto, int orderBy) {
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			if (tipo == FORM_INSERT){
				...
				descricao = "Fiorino, Corola, Corsa...";
				buttonLabel = "Inserir";
			} else {
			...
			umProduto += "\t\t\t<td>Motor: <input class=\"input--register\" type=\"text\" name=\"dataValidade\" value=\""+ produto.getMotor() + "\"></td>";
			...
			umProduto += "\t\t\t<td>Motor: "+ produto.getMotor() +"</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
		...
		list += "\n<tr><td colspan=\"6\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;Relação de Veículos</b></font></td></tr>\n" +
	...
	public Object insert(Request request, Response response) {
		...
		Produto produto = new Produto(-1, descricao, preco, quantidade, dataFabricacao, motor);
	...
	public Object update(Request request, Response response) {
        ...
        if (produto != null) {
        	...
        	produto.setMotor(request.queryParams("motor"));
